...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `scheme_list` where id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
...
<div class="container-fluid">
	<form action="" id="vaccine-form">
		...
		<div class="form-group">
			...
			<textarea name="name" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($amount) ? $amount : ''; ?></textarea>
		</div>
		<div class="form-group">
...
<script>
	...
	$(document).ready(function(){
		...
		$('#vaccine-form').submit(function(e){
			...
			start_loader();
			$.ajax({
				url:_base_url_+"classes/Master.php?f=save_scheme",
