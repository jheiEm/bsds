...
$sql = "SELECT * FROM individual_list where status_client = 1 ORDER BY date_created ASC";
...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <div class="container-fluid">
            ...
            <!-- Mass Update Button -->
            <button id="massUpdateBtn" class="btn btn-success" hidden="hidden">Mass Update</button>
        </div>
    </div>
</div>
...
<script>
    ...
    $('#filterBtn').on('click', function() {
        ...
        $.ajax({
            url: 'archives_f/filter.php', // Assuming filter.php will handle the filtering logic
            type: 'GET',
            data: {
                schemeId: schemeId,
                districtId: districtId,
            ...
            success: function(data) {
                ...
                $(document).on('click', '.editBtn', function() {
                    ...
                    $.ajax({
                        url: 'archives_f/fetch_individual.php', // This file will fetch the individual data
                        type: 'GET',
                ...
                $(document).on('click', '.deleteBtn', function() {
                    ...
                    if (confirm('Are you sure you want to delete this individual?')) {
                        $.ajax({
                            url: 'archives_f/delete_individual.php', // File for deleting individual
                            type: 'POST',
                            data: { id: individualId },
                            success: function(response) {
                                alert(response);
    ...
    $('#search').on('keyup', function() {
        ...
        $.ajax({
            url: 'archives_f/search.php', // We'll create this file next
            type: 'GET',
    ...
    $('#editForm').on('submit', function(e) {
        ...
        $.ajax({
            url: 'archives_f/edit_individual.php', // This file will update the individual
            type: 'POST',
            data: formData,
            success: function(response) {
                alert(response);
    ...
    $('#massUpdateBtn').on('click', function() {
        ...
        $.ajax({
            url: 'archives_f/mass_update.php', // We'll create this file next
            type: 'POST',
