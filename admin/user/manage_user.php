	...
	<div class="card-body">
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group col-6">
					<label for="location_id">Disbursement Area</label>
					<select name="location_id" id="location_id" class="custom-select custom-select-sm select2">
						...
						?>
						<option value="<?php echo $row['location'] ?>" <?php echo isset($meta['location']) && $meta['location'] == $row['location'] ? 'selected' : '' ?>><?php echo $row['location'] ?></option>
						<?php endwhile; ?>
					</select>
				</div>
				<div class="form-group col-6">
