...
<div class="card card-outline card-info">
            ...
            <div class="form-group row">
				<div class="col-md-6">
					...
					<select name="status" id="status" class="custom-select select" required>
						...
						<option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>Disbursement Completed (Partially Disbursed)</option>
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=reschedule">Cancel</a>
	</div>
</div>
<script>
