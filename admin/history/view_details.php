<?php 
 ...
 $location_qry = $conn->query("SELECT * FROM scholar_location_list where id ='{$location_id}'");
...
<div class="card card-outline card-primary">
    <div class="card-header d-flex">
        <h5 class="card-title col-auto flex-grow-1">Disbursement History Record Details</h5>
        <div class="col-auto">
        ...
        <div class="container-fluid" id="print_out">
            <div class="row">
			 ...
			 <dt class="text-muted">Mother's Name:</dt>
                        <dd class="pl-4"><?php echo isset($result_indi['name']) ? $result_indi['mother_fullname'] : '' ?></dd>
			 <dt class="text-muted">Father's Name:</dt>
                        <dd class="pl-4"><?php echo isset($result_indi['name']) ? $result_indi['father_fullname'] : '' ?></dd>
			 ...
			 <dt class="text-muted">Age:</dt>
                        <dd class="pl-4"><?php echo isset($result_indi['age']) ? $result_indi['age'] : '' ?></dd>
			   ...
			   <dt class="text-muted">Address:</dt>
                        ...
                        <dt class="text-muted">Scholarship Type:</dt>
                        <dd class="pl-4"><?php echo isset($result_scheme['name']) ? $result_scheme['name'] : '' ?></dd>
                        <dt class="text-muted">Disbursed By:</dt>
                        <dd class="pl-4"><?php echo isset($reviewed_by) ? $reviewed_by : '' ?></dd>
                        <dt class="text-muted">Disbursed at:</dt>
                        ...
                        <input type="hidden" name="scheme_id" id="scheme_id" value="<?php echo isset($result_scheme['id']) ? $result_scheme['id'] : '' ?>">
                    </dl>
                </div>
            </div>
        </div>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            _el.append('<div class="d-flex justify-content-center">'+
                      ...
                      '<h4 class="text-center">Student Record Details</h4>'+
                      '</div>'+
                      '<div class="col-1 text-right">'+
                      '</div>'+
                      '</div><hr/>')
