    ...
    <div class="card-body">
        <form action="" id="history-form">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    <div class="mb-2">
                        <label for="vaccination_type" class="control-label">Scholarship Disbursement Status</label>
                        <select name="vaccination_type" id="vaccination_type" class="custom-select select" required>
                            <option <?php echo isset($vaccination_type) && $vaccination_type == 'Pending' ? 'selected' : '' ?>>Pending</option>
                            <option <?php echo isset($vaccination_type) && $vaccination_type == '1st Disbursement Completed (Partially Disbursed)' ? 'selected' : '' ?>>1st Disbursement Completed (Partially Disbursed)</option>
                            <option <?php echo isset($vaccination_type) && $vaccination_type == '2nd Disbursement Completed (Partially Disbursed)' ? 'selected' : '' ?>>2nd Disbursement Completed (Partially Disbursed)</option>
                            <option <?php echo isset($vaccination_type) && $vaccination_type == '3rd Disbursement Completed (Fully Disbursed)' ? 'selected' : '' ?>>3rd Disbursement Completed (Fully Disbursed)</option>
                        </select>
                    </div>
                    <div class="">
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(!!resp.id){
                        ...
                        $('dd.indi_vaccinationtype').text(resp.vaccination_type)
                        ...
                        if (resp.status == 0) {
                            ...
                            $('dd.indi_status').text('1st Disbursement Completed (Partially Disbursed)');
                        } else if (resp.status == 2) {
                            $('dd.indi_status').text('2nd Disbursement Completed (Partially Disbursed)');
                        } else if (resp.status == 4) {
                            $('dd.indi_status').text('3rd Disbursement Completed (Fully Disbursed)');
