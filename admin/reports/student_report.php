...
<div class="card card-outline card-blue rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title">Student Record Report</h3>
        ...
        <div class="container-fluid">
			<div class="row">
				...
				<div class="col-8">
					...
					<h3 class="text-center"><b>Student Record Report</b></h3>
			...
			<table class="table table-bordered table-hover table-striped">
				...
				<tbody>
					<?php 
						$i = 1;
						$qry = $conn->query("SELECT * from `student_list` where date(date_created) between '{$from}' and '{$to}' order by unix_timestamp(date_created) asc ");
					...
					<?php if($qry->num_rows <= 0): ?>
						<tr>
							<th class="py-1 text-center" colspan="6">No Student Record Found.</th>
						</tr>
					<?php endif; ?>
				</tbody>
			</table>
...
<script>
	$(document).ready(function(){
        ...
        $('#filter').submit(function(e){
            e.preventDefault();
            location.href= './?page=reports/student_report&'+$(this).serialize();
        })
