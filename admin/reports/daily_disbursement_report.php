...
<div class="card card-outline card-blue rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title">Daily Disbursement Report</h3>
        ...
        <div class="container-fluid">
			<div class="row">
				...
				<div class="col-8">
					...
					<h3 class="text-center"><b>Daily Disbursement Report</b></h3>
			...
			<table class="table table-bordered table-hover table-striped">
				...
				<?php 
					$i = 1;
						...
						$qry = $conn->query("SELECT h.*,concat(i.lastname,', ',i.firstname,' ', i.middlename) as iname,i.tracking_code FROM `scholar_history_list` h inner join individual_list i on h.individual_id = i.id WHERE DATE(h.date_created)= '{$date}'
					...
					?>
						...
						<tr>
							...
							<td class="py-1 px-2">
								<small><span class="text-muted">Scholarship Grant:</span> <b><?php echo isset($vax_arr[$row['scheme_id']]) ? $vax_arr[$row['scheme_id']] : 'Scheme was Deleted' ; ?></b></small> <br>
								
								<small><span class="text-muted">Disbursed by:</span> <br/> <b><?php echo $row['reviewed_by'] ?></b></small>
								
								<small><span class="text-muted"><br/>Disbursed at: </span> <br/>  <b><?php echo isset($location_arr[$row['district_name']]) ? $location_arr[$row['district_name']] : '' ; ?></b></small> <br/>
							</td>
							
							<td class="py-1 px-2">
								
							
							<small><span class="text-muted"></span> <b><?php echo $row['disbursement_status'] ?></b></small>
							...
							<td class="py-1 px-2">
								<small><span class="text-muted"><?php echo isset($indiv_arr[$row['individual_id']]) ? $indiv_arr[$row['individual_id']] : '' ; ?></b></small> <br>
							</td>
							<td class="py-1 px-2">
								<small><span class="text-muted"><?php echo isset($contact_arr[$row['individual_id']]) ? $contact_arr[$row['individual_id']] : '' ; ?></b></small> <br>
							</td>
							<td class="py-1 px-2">
								<small><span class="text-muted"><?php echo isset($age_arr[$row['individual_id']]) ? $age_arr[$row['individual_id']] : '' ; ?></b></small> <br>
							</td>
							<td class="py-1 px-2">
								<small><span class="text-muted"><?php echo isset($address_arr[$row['individual_id']]) ? $address_arr[$row['individual_id']] : '' ; ?></b></small> <br>
							</td>
...
<script>
	$(document).ready(function(){
		$('#filter').submit(function(e){
            e.preventDefault();
            location.href= './?page=reports/daily_disbursement_report&'+$(this).serialize();
        })
