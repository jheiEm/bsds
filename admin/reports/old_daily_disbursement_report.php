                    ...
                    while($row = $qry->fetch_assoc()):
                        ...
                        <tr>
                            ...
                            <td class="py-1 px-2">
                                ...
                                <small><span class="text-muted"><br/>Disbursed at: </span> <br/>  <b><?php echo isset($location_arr[$row['location_id']]) ? $location_arr[$row['location_id']] : '' ; ?></b></small> <br/>
                            </td>

                            <td class="py-1 px-2">


                                <small><span class="text-muted"></span> <b><?php echo $row['vaccination_type'] ?></b></small>
