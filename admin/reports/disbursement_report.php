				...
				<?php 
					...
					?>
						...
						<tr>
							...
							<td class="py-1 px-2">
								<small><span class="text-muted">Scholarship Type:</span> <b><?php echo isset($vax_arr[$row['scheme_id']]) ? $vax_arr[$row['scheme_id']] : 'Vaccine was Deleted' ; ?></b></small> <br>
								
								<small><span class="text-muted">Reviewed by:</span> <br/> <b><?php echo $row['reviewed_by'] ?></b></small>
								
								<small><span class="text-muted"><br/>Location to be disbursed at: </span> <br/>  <b><?php echo isset($location_arr[$row['district_name']]) ? $location_arr[$row['district_name']] : '' ; ?></b></small> <br/>
							</td>
