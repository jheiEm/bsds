...
$sql = "SELECT * FROM individual_list ORDER BY date_created ASC";
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#individualTable').DataTable({
            columnDefs: [
        ...
        $('#filterBtn').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Reinitialize DataTable with pagination and sorting
                    table.clear();  // Clear any previous DataTable data
                    table.rows.add($(data));  // Add the new rows of filtered data
                    table.draw();  // Redraw DataTable to apply pagination and sorting
                }
            });
        });
        ...
        $('#search').on('keyup', function() {
            ...
            $.ajax({
                url: 'approval_f/search.php', // Search functionality handler
                type: 'GET',
                ...
                success: function(data) {
                    ...
                    // Reinitialize DataTable with pagination and sorting
                    table.clear();  // Clear previous DataTable data
                    table.rows.add($(data));  // Add new rows
                    table.draw();  // Redraw DataTable to apply pagination and sorting
                }
            });
        });
        ...
        $(document).on('click', '.editBtn', function() {
            ...
            $.ajax({
                url: 'approval_f/fetch_individual.php',
                type: 'GET',
        ...
        $(document).on('click', '.deleteBtn', function() {
            ...
            if (confirm('Are you sure you want to delete this individual?')) {
                $.ajax({
                    url: 'approval_f/delete_individual.php',
                    type: 'POST',
                    data: { id: individualId },
                    success: function(response) {
                        alert(response);
        ...
        // Handle Mass Update Button Click
        $('#massUpdateBtn').on('click', function() {
            ...
            $.ajax({
                url: 'approval_f/mass_update.php',
                type: 'POST',
        ...
        $('#clearFiltersBtn').on('click', function() {
            $('#schemeFilter').val('');
            $('#districtFilter').val('');
            $('#schoolLevelFilter').val('');
            $('#statusFilter').val('');
            $('#filterBtn').trigger('click');  // Trigger the filter button click to reload with no filters
        });
    });
</script>
