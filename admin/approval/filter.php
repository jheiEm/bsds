...
if ($schemeId) $query .= " AND scheme_id = '$schemeId' ORDER BY date_created ASC";
if ($districtId) $query .= " AND district_name = '$districtId' ORDER BY date_created ASC";
if ($schoolLevel) $query .= " AND school_level = '$schoolLevel' ORDER BY date_created ASC";
if ($status !== '') $query .= " AND status = '$status' ORDER BY date_created ASC";


//// Order by date_created in ascending order
//$query .= " ORDER BY date_created ASC";  // Change ASC to DESC for descending order (newest first)
