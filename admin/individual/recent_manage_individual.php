...
<div class="card card-outline card-info">
    <div class="card-header">
        <h3 class="card-title"><?php echo isset($id) ? "Update ": "Add New " ?> Individual Details</h3>
    </div>
    <div class="card-body">
        <form action="" id="individual-form">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    <label for="status" class="control-label">Disbursement Status</label>
                    <select name="status" id="status" class="custom-select select" required>
                        <option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Pending</option>
                        <option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>1st Disbursement Completed (Partially Disbursed)</option>
                        <option value="2" <?php echo isset($status) && $status == 2 ? 'selected' : '' ?>>2nd Disbursement Completed (Partially Disbursed)</option>
                        <option value="4" <?php echo isset($status) && $status == 4 ? 'selected' : '' ?>>3rd Disbursement Completed (Fully Disbursed)</option>
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    <label for="schedule" class="control-label">Schedule of Disbursement</label>
                    <input type="datetime-local" class="form-control form-control-sm rounded-0" id="schedule"  name="schedule" value="<?php echo isset($schedule) ? $schedule :'' ?>">
    ...
    <div class="card-footer">
        ...
        <a class="btn btn-flat btn-default" href="?page=individual">Cancel</a>
    </div>
</div>
<script>
