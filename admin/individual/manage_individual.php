...
<div class="card card-outline card-info">
	...
	<div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm rounded-0" id="middlename" name="middlename" value="<?php echo isset($middlename) ? $middlename :'' ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
				<div class="col-md-6">
					...
					<select name="status" id="status" class="custom-select select" required>
						...
						<option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>Approved for Disbursement</option>
                        <option value="1" <?php echo isset($status) && $status == 2 ? 'selected' : '' ?>>Fully Disbursed</option>
		...
		<div class="form-group row">
				...
				<input type="date" class="form-control form-control-sm rounded-0" id="schedule"  name="schedule" value="<?php echo isset($schedule) ? $schedule :'' ?>">
