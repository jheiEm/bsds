...
// Prepare the SQL statement
    ...
    (tracking_code, mother_fullname, father_fullname, firstname, middlename, lastname, gender, dob, age, contact, address, email, district_name, enrollment_date, school_name, school_level, schedule_date, date_created, date_updated) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())";
...
// Bind parameters and their data types
    $stmt->bind_param("sssssssssssssssss", $code, $motherFullname, $fatherFullname, $firstname, $middlename, $lastname, $gender, $dob, $age, $contact, $address, $emailadd, $district_name, $enrollment_date, $school_name, $school_level, $requested_schedule);
...
// Execute the statement
    if ($stmt->execute()) {
        ...
        require "mail.php";
        $requested_schedule = new DateTime();  // Example: Current date and time
...
// Call the send_mail function with the formatted date
        ...
        $recipients = [''];
        $bccRecipients = ['merujeshua@gmail.com', 'lumberajudel@gmail.com', 'alexis.aquino.lumbera7@gmail.com']; // BCC email

        // Define the subject and message
        $subject = 'Confirmation Schedule';
        $message = "Your schedule is confirmed on " . $formatted_schedule;
        send_mail($recipients, $subject, $message, $bccRecipients);
        exit();
    } else {
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="requested_schedule" name="requested_schedule" class="form-control" required>
                        </div>
