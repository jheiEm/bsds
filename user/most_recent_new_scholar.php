...
// Prepare the SQL statement
    ...
    (tracking_code, mother_fullname, father_fullname, firstname, middlename, lastname, gender, dob, age, contact, address, email, district_name, enrollment_date, school_name, school_level, date_created, date_updated) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())";
...
// Bind parameters and their data types
    $stmt->bind_param("ssssssssssssssss", $code, $motherFullname, $fatherFullname, $firstname, $middlename, $lastname, $gender, $dob, $age, $contact, $address, $emailadd, $district_name, $enrollment_date, $school_name, $school_level);
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        ...
                        <button type="button" class="btn btn-primary" id="checkAvailabilityBtn">Check Availability</button>
